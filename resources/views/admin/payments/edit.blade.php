        ...
        <form action="{{ route('admin.payments.update', $payment) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <select name="purchase_id" id="purchase_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('purchase_id') border-red-500 @enderror" required>
                    ...
                    <option value="{{ $purchase->id }}" @selected(old('purchase_id', $payment->purchase_id) == $purchase->id)>
            ...
            <div class="mb-6">
                ...
                <input type="date" name="payment_date" id="payment_date" value="{{ old('payment_date', $payment->payment_date->format('Y-m-d')) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('payment_date') border-red-500 @enderror" required>
                @error('payment_date')
                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="number" name="amount" id="amount" step="0.01" min="0.01" value="{{ old('amount', $payment->amount) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('amount') border-red-500 @enderror" required>
                @error('amount')
                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <select name="payment_method" id="payment_method" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('payment_method') border-red-500 @enderror" required>
                    ...
                    <option value="credit_card" @selected(old('payment_method', $payment->payment_method) == 'credit_card')>Credit Card</option>
            ...
            <div class="mb-6">
                ...
                <select name="payment_status" id="payment_status" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 @error('payment_status') border-red-500 @enderror" required>
                    ...
                    <option value="cancelled" @selected(old('payment_status', $payment->payment_status) == 'cancelled')>Cancelled</option>
                </select>
            ...
            <div class="mb-6">
                ...
                <input type="text" name="reference_number" id="reference_number" value="{{ old('reference_number', $payment->reference_number) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="mb-6">
                ...
                <textarea name="notes" id="notes" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('notes', $payment->notes) }}</textarea>
                @error('notes')
                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
