            ...
            <tbody class="divide-y divide-gray-200">
                @forelse ($returns as $index => $return)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-600">{{ $return->purchase->supplier_name ?? '-' }}</td>
                        ...
                        <td class="px-6 py-4 text-sm flex gap-3">
                            <a href="{{ route('admin.purchase-returns.show', $return) }}" class="text-green-500 hover:text-green-700 transition" title="View">
                ...
                @empty
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center text-gray-500">No purchase returns found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
