                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-sm">
                        ...
                        <div class="flex justify-center items-center gap-3">
                            @if ($firstSellId)
                                <a href="{{ route('admin.sells.show', $firstSellId) }}"
                            ...
                            <a href="{{ route('admin.sell-invoices.export', $inv) }}"
                            ...
                            <form action="{{ route('admin.sell-invoices.destroy', $inv) }}" method="POST" class="inline-flex" onsubmit="return confirm('Remove this invoice from the list? Sales can be invoiced again for this type. The record is kept internally.');">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
