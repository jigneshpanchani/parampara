        ...
        <div class="min-h-screen flex">
            ...
            <div class="w-64 bg-gray-900 text-white shadow-lg">
                ...
                <nav class="mt-6 pb-32">
                    ...
                    <a href="{{ route('admin.sell-invoices.index') }}" class="block px-6 py-3 hover:bg-gray-800 transition {{ request()->routeIs('admin.sell-invoices.*') ? 'bg-gray-800 border-l-4 border-blue-500' : '' }}">
                        <span class="flex items-center">
                            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
