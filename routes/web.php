...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('reports/sales/pdf', [ReportController::class, 'exportSalesPdf'])->name('reports.sales.pdf');
        ...
        Route::get('reports/pay-later', [ReportController::class, 'payLater'])->name('reports.pay-later');
        Route::post('reports/pay-later/export', [ReportController::class, 'exportPayLater'])->name('reports.pay-later.export');
        Route::post('reports/pay-later/pdf', [ReportController::class, 'exportPayLaterPdf'])->name('reports.pay-later.pdf');
        ...
        Route::get('stock-closings/{stockClosing}',    [StockClosingController::class, 'show'])->name('stock-closings.show');
        Route::delete('stock-closings/{stockClosing}', [StockClosingController::class, 'destroy'])->name('stock-closings.destroy');
